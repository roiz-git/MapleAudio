...
MpdIOS is a streamlined MPD (Music Player Daemon) client designed for music lovers who want efficient control without visual distractions. Text-based, fast, and focused.

HOW IT WORKS

MpdIOS is built around two primary listening modes:
...
COMPANION TO MpdMacOS

Part of the MpdForApple family. MpdIOS shares its core with MpdMacOS, our menu bar client for Mac.
